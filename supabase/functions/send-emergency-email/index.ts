...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
              ...
              <body>
                <div class="container">
                  ...
                  <div class="content">
                    ...
                    <p style="font-size: 16px;">Your emergency contact has triggered an emergency alert and needs assistance.</p>
                    <div class="info-box">
                    ...
                    <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd;">
                      <p style="color: #666; font-size: 14px;">
                        ...
                        3. Share location with authorities if needed
                      </p>
                    </div>
                  </div>
    ...
    const smsPromises = contacts.filter(c => c.phone).map(async (contact) => {
      try {
